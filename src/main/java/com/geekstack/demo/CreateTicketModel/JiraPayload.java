...
package com.geekstack.demo.CreateTicketModel;
...
public class JiraPayload {
    ...
    @JsonProperty("fields")
    private com.geekstack.demo.CreateTicketModel.Fields fields;

    @JsonProperty("fields")
    public com.geekstack.demo.CreateTicketModel.Fields getFields() {
        return fields;
    }
